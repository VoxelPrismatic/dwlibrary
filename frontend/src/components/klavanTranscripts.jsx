...
const AKTranscriptCard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const titlesResponse = await axios.get(
        `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/aktitles?page=${currentPage}`
      );
      ...
      const endpoint = isSearchActive
        ? `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/aktranscripts?query=${encodedSearchInputs.join(
            ","
          )}&page=${currentPage}`
        : `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/aktranscripts?page=${currentPage}`;
  ...
  const fetchMetadata = async () => {
    try {
      ...
      const metaResponse = await axios.get(
        "https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/aktranscripts/meta"
      );
  ...
  const fetchTitleMetadata = async () => {
    try {
      // Fetch metadata
      const metaResponse = await axios.get(
        "https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/aktitles/meta"
      );
      const totalCount = metaResponse.data.totalCount;
      setTotalItems(totalCount);
    } catch (error) {
  ...
  const fetchTranscript = async (episodeNumber) => {
    try {
      const response = await axios.get(
        `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/aktranscripts/${episodeNumber}`
      );
...
export default AKTranscriptCard;
