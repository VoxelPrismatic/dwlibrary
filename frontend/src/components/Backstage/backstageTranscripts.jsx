...
const TranscriptCard = () => {
  ...
  console.log("the number", totalItems);
  ...
  const fetchData = async () => {
    try {
      ...
      const titlesResponse = await axios.get(
        `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetitles?page=${currentPage}`
      );
      ...
      const endpoint = isSearchActive
        ? `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetranscripts?query=${encodedSearchInputs.join(
            ","
          )}&page=${currentPage}`
        : `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetranscripts?page=${currentPage}`;
  ...
  const fetchMetadata = async () => {
    try {
      ...
      const metaResponse = await axios.get(
        "https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetranscripts/meta"
      );
  ...
  const fetchTitleMetadata = async () => {
    try {
      // Fetch metadata
      const metaResponse = await axios.get(
        "https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetitles/meta"
      );
      const totalCount = metaResponse.data.totalCount;
      setTotalItems(totalCount);
    } catch (error) {
  ...
  const fetchTranscript = async (episodeNumber) => {
    try {
      const response = await axios.get(
        `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetranscripts/${episodeNumber}`
      );
  ...
  const handleSearchSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/backstagetranscripts",
        {
          params: {
            query: searchQuery
          }
  ...
  const handlePageChange = (pageNumber) => {
    ...
    navigate(`/backstage?page=${pageNumber}`);
  };
