...
const MKTranscriptCard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const endpoint = isSearchActive
        ? `https://the-sweet-baby-gang-backend-git-main-tyler-sowers-projects.vercel.app/api/mktranscripts?query=${encodedSearchInput}&page=${currentPage}`
  ...
  const handleSearchSubmit = async () => {
    ...
    try {
      // Fetch search results from the /mktranscripts API
      const response = await axios.get(
...
export default MKTranscriptCard;
